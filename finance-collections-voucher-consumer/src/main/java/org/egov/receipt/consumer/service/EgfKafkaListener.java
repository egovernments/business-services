        	...
        	if(voucherService.isTenantEnabledInFinanceModule(recRequest, finSerMdms)){
        		...
        		if(topic.equals(manager.getVoucherCreateTopic())){
					...
					for (Receipt recpt : recRequest.getReceipt()) {
						...
						VoucherResponse voucherByServiceAndRefDoc = voucherService.getVoucherByServiceAndRefDoc(recRequestTemp.getRequestInfo(), recpt.getTenantId(), bill.getBusinessService(), recpt.getPaymentId());
