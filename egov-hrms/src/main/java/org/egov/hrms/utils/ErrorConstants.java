...
public class ErrorConstants {
	...
	public static final String HRMS_UPDATE_DEACT_DETAILS_INCORRECT_EFFECTIVEFROM_MSG2 = "Employee deactivation effective date should not be before date of appointment.";
	...
	public static final String HRMS_UPDATE_REACT_DETAILS_INCORRECT_EFFECTIVEFROM_MSG = "Employee reactivation effective date should not be past date.";
